...
description: |
  ...
  Examples:
    - "Review the architecture of this feature before I start building"
    - "What patterns should we use for this new service?"
    - "Evaluate the trade-offs between these two approaches"
    - "Help me plan the data model for this feature"
model: inherit
---
